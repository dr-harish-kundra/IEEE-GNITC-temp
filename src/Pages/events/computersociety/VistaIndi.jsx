      ...
      <div className="bluebg ">
        ...
        <div className="about flex m-3 p-3 flex-col">
          ...
          <span className=" text-lg fontt cen md:w-[85%]">
            ...
            explicabo temporibus. Aliquam eveniet quidem rem perspiciatis
            recusandae assumenda vitae totam, maiores excepturi! Suscipit quas
            blanditiis, itaque ex, deserunt ad totam similique deleniti dolorum
            aliquid amet id molestias repudiandae temporibus numquam corporis,
            ipsam necessitatibus? Consectetur, soluta accusamus. Nemo, quo iure.
          </span>
        </div>
